...
const Header = ({currentUser,handleOpenMenu,openMenu1}) => {
...
setOpenMenu(openMenu1)
  ...
  return (
    <div className=' w-screen bg-gray-100 text-gray-800 shadow-md  header flex justify-center items-center h-11 lg:h-12'>
