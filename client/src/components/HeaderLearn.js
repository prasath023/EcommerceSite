...
const HeaderLearn = ({currentUser,handleOpenMenu,openMenu1}) => {
  ...
  return (
    <div className=' w-screen bg-gray-100 text-gray-800 shadow-md  header flex justify-center items-center h-11 lg:h-14'>
      <nav className='flex justify-between items-center w-full'>
        ...
        <Link className='outline-none text-xs lg:text-sm pr-3'  to={`/learn/courses/mycourses`}>
      My Courses
      </Link>
        ...
        <Link className='outline-none'  to="/favorite-courses"> <FavoriteBorderSharpIcon fontSize='large'/></Link>
        </div>
        ...
        <Link className='outline-none'  to="/favorite-courses"> <FavoriteBorderSharpIcon fontSize='medium'/></Link>
        </div>
